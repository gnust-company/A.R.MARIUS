export const en = {
  ...
  firstSteps: {
    ...
    aboutYouLead: 'This is the name your team sees. You can change it whenever you like.',
    nameLabel: 'Display name',
    namePlaceholder: 'e.g. Vu',
    workspaceTitle: 'Your workspace',
    workspaceLead: 'Give it a name. Your projects, agents and machines live in here.',
    workspaceLabel: 'Workspace name',
    workspacePlaceholder: 'e.g. Home Studio',
    noWorkspace: 'We could not find a workspace of yours. Reload the page and try again.',
    connectTitle: 'Connect a machine',
    connectLead: 'Agents run on your machines, not ours. Install the daemon and link that machine here.',
    installStep: 'On your machine, run this to install it:',
    loginStep: 'Then link it to your account:',
    loginStepHint: 'That command opens the approval page for you — look at the machine, then approve.',
    startStep: 'Then start it running:',
    startStepHint: 'Leave this one running. Linking hands over the credentials; this is what takes work.',
    readGuide: 'Read the guide',
    copy: 'Copy command',
    next: 'Next',
    back: 'Back',
    done: 'Done — take me in',
    skip: 'Later — a machine can be added any time',
  },
  linkMachine: {
    ...
    doneStart: 'Then run `armarius-daemon start` there and leave it running. Until you do, the machine is linked but takes no work.',
    doneFirstSteps: 'That was the last of your first steps, so they are done. The window you started in has already gone on to your workspace — you can close this one.',
  ...
  createProject: {
    ...
    mode: {
      ...
      setupWorkspaceAgent: 'Agent-assisted project creation needs this workspace\'s Workspace Agent to be online. It is ready once a linked machine has an agent CLI that runs — link a machine or start its daemon from the Machines screen.',
    },
    steps: {
      project: 'Project',
      roster: 'Roster',
  ...
  onboarding: {
    ...
    waOfflineHint:
      'The Workspace Agent must be online to run this interview. Check its machine on the Machines screen, then retry.',
    retry: 'Retry',
  },
  directory: {
    ...
    createAndSwap: 'Create and replace',
    ...
    deleteConfirm: 'Delete the agent "{{name}}"? Its run history goes with it, and this can\'t be undone.',
  ...
  agentChat: {
    ...
    online: 'Online',
    offline: 'Offline',
    offlineBanner: 'This agent cannot be reached, so it cannot be written to — the Health panel says why.',
    empty: 'No messages yet. Write to {{name}} to start.',
    thinking: '{{name}} is replying…',
    turnFailed: 'That reply did not finish. Try sending again.',
    inputLabel: 'Message {{name}}',
    inputDisabled: 'The agent is offline.',
    inputThinking: 'Waiting for the reply…',
    inputPlaceholder: 'Message {{name}}… (Enter to send)',
    send: 'Send',
  },
  leaderChat: {
  ...
  runTrace: {
    ...
    noEventsAtAll: 'This run produced no events at all — it {{outcome}}. There is nothing to filter.',
    noEventsAtAllUnknown: 'This run produced no events at all. There is nothing to filter.',
    outcome: {
      queued: 'has not started yet',
      running: 'is still running',
      completed: 'finished without saying anything',
      failed: 'failed',
      timed_out: 'went quiet and was timed out',
      stopped: 'was stopped',
    },
  ...
  agentDetail: {
    ...
    instructions: {
      systemLabel: 'Written by Armarius',
      systemHint: 'The job that makes this agent the host of your workspace. You cannot change it — it is here so you can see what it already says.',
      ownLabel: 'Instructions',
      ownLabelWithSystem: 'Your instructions',
      ownHint: 'Who this agent is and how it works. It is sent on every run, and it is the only thing that says how this agent behaves.',
      placeholder: 'e.g. You review pull requests. Be blunt, quote the line, and never approve a change you have not read.',
      save: 'Save',
      savedNextRun: 'Saved. It applies from the next run.',
    },
    skillsTab: {
      hint: 'The skills this agent carries. Each one travels down with the work that needs it, every run.',
      none: 'This agent carries no skills yet.',
      removeAria: 'Take {{name}} off this agent',
    },
    settingsTab: {
      nameLabel: 'Name',
      descriptionLabel: 'Description',
      descriptionHint: 'What your team calls this agent. Never sent to the agent itself.',
      descriptionPlaceholder: 'e.g. Reviews pull requests on the web repo',
      save: 'Save',
      saved: 'Saved.',
      runtimeHeading: 'How it runs',
      runsOn: 'Runs as {{cli}} on the machine {{machine}}.',
      runsNowhere: 'This agent has nowhere to work — its machine was removed, or it was never placed anywhere.',
      saveRuntime: 'Save run settings',
      runtimeDefaults: 'Nothing was picked — its tool runs on its own defaults.',
    },
    backToAgents: 'Back to agents',
    runtimeLine: '{{cli}} on {{machine}}',
    runtimeNone: 'Nowhere to work',
    modelDefault: 'CLI default model',
    ...
    linkSkills: {
      ...
      hint: 'Pick the skills this agent may use. They are written onto the machine that runs it, on every run — there is nothing to install and nothing to wait for.',
      ...
      sent: 'Linked. The agent has them from its next run on.',
      sendFailed: 'Could not save the change. Try again.',
      sending: 'Saving…',
      confirm: 'Link skills',
      retry: 'Retry',
      reinstallHint: 'Already linked — the newest copy goes down on every run',
      linkedTag: 'linked',
    },
    ...
    wakeReason: {
      ...
      agent_chat_message: 'The patron wrote to this agent directly.',
  ...
  errors: {
    ...
    workspace_agent_not_set_up: 'The Workspace Agent is not ready — it needs a linked machine with an agent CLI that runs. Link a machine or start its daemon from the Machines screen, then retry.',
    ...
    artifact_has_no_stored_bytes: 'This artifact is a link to somewhere else, so there is nothing here to download.',
