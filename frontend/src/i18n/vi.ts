export const vi = {
  ...
  onboarding: {
    ...
    waiting: 'Tác nhân Không gian đang soạn câu tiếp theo…',
    submit: 'Tiếp tục',
    pickOne: 'Chọn một',
  ...
  agentDetail: {
    ...
    settingsTab: {
      ...
      runtimeHint: 'Những gì agent này được đặt ở chỗ nó làm ({{runtime}}). Đổi ở màn đặt chỗ làm — tuỳ chọn nào nhận được là câu trả lời của chỗ ấy.',
